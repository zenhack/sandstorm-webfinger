...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "vaqj7fryqvvvakyszrfe9xugmt1fsdpt5cu1vccf8evdm3jdxrxh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Webfinger Host"),
    ...
    actions = [
      ...
      ( nounPhrase = (defaultText = "webfinger server"),
        command = .myCommand
    ...
    metadata = (
      ...
      website = "https://github.com/zenhack/sandstorm-webfinger",
      # This should be the app's main website url.

      codeUrl = "https://github.com/zenhack/sandstorm-webfinger",
      ...
      shortDescription = (defaultText = "Webfinger host"),
...
const myCommand :Spk.Manifest.Command = (
  ...
  argv = ["/sandstorm-http-bridge", "8000", "--", "/sandstorm-webfinger"],
  environ = [
    # Note that this defines the *entire* environment seen by your app.
    (key = "PATH", value = "/usr/local/bin:/usr/bin:/bin"),
    (key = "ASSET_PATH", value="/"),
